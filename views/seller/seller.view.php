...
<div class="flex items-start">
  ...
  <div class="tab-content w-full m-5 text-white">
    ...
    <div class="hidden opacity-100 transition-opacity duration-150 ease-linear data-[te-tab-active]:block" id="tab-home" role="tabpanel" aria-labelledby="tabs-home-tab03" data-te-tab-active>
      ...
      <div class="main chart grid grid-cols-2 gap-4">
        <!-- ====== It's just store id to make it not error =====  -->
        <input type="hidden" id="toggleSidebarMobile">
        <input type="hidden" id="sidebarBackdrop">
        <input type="hidden" id="toggleSidebarMobileSearch">

        <div class="main-left mb-4 w-full rounded flex bg-gray-50">
          <div class="bg-gray-900 opacity-50 hidden fixed inset-0 z-10 w-full">

          </div>
          <div id="all-review" class="bg-slate-800 pt-6 px-4 w-full text-white">
            <div class="w-full">
              <div class="flex flex-col shadow rounded-lg p-4 sm:p-6 xl:p-8  2xl:col-span-2">
                <div class="flex items-center mb-4 w-full">
                  <div class="flex-shrink-0">
                    <span class="text-2xl sm:text-3xl leading-none font-bold text-white">$ <?= round($total_balances / 7) ?></span>
                    <h3 class="text-base font-normal text-gray-300">Bookings this week</h3>
                  </div>
                  <div class="flex items-center justify-end flex-1 text-green-500 text-base font-bold">
                    <?= round(($total_balances / 100), 2) . " %" ?>
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                      <path fill-rule="evenodd" d="M5.293 7.707a1 1 0 010-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 01-1.414 1.414L11 5.414V17a1 1 0 11-2 0V5.414L6.707 7.707a1 1 0 01-1.414 0z" clip-rule="evenodd"></path>
                    </svg>
                  </div>
                </div>
                <div class="w-full" id="main-chart"></div>
              </div>
            </div>
          </div>
        </div>
        <div class="grid grid-cols-1 gap-4">
          <div id="all-review" class="left flex items-center justify-center mb-4 rounded bg-slate-800">
